...
CREATE TABLE IF NOT EXISTS pedidos (
  ...
  data_entrega_real DATETIME NULL AFTER previsao_entrega,
  valor_total DECIMAL(12,2) DEFAULT 0,
  observacoes TEXT,
  data_aprovacao DATETIME,
  motivo_rejeicao TEXT,
  duplicidade_ignorada BOOLEAN NOT NULL DEFAULT FALSE,
  triagem ENUM('urgente','carro_vendido','carro_estoque') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS pedido_itens (
  ...
  descricao VARCHAR(255) NULL AFTER peca_id,
  fornecedor_id INT,
